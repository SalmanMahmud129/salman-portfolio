...
function ProjectShowcase() {
  ...
  return (
    <section name='projects' className='w-full h-11/12 bg-blue-300/10' >
      <motion.div variants={staggerContainer} initial="hidden" whileInView='show' viewport={{once: false, amount: 0.25}}  className=' max-w-screen-2xl px-5 py-10 mx-auto flex flex-col justify-center w-full h-full'>
